...
import { useFacebookGroups, useAddGroup, useRemoveGroup } from "@/hooks/use-facebook-groups"
    ...
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="outline" size="sm">
          <Settings className="mr-2 h-4 w-4" />Quan ly Groups
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <Input placeholder="Ten nhom" value={name} onChange={(e) => setName(e.target.value)} />
            <Input
          ...
          <div className="space-y-2">
            ...
            {groups.map((group) => (
              <div key={group.id} className="flex items-center justify-between rounded-md border p-2">
